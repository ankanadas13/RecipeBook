...
--
-- Host: 127.0.0.1
-- Generation Time: 25 Apr 2019 pada 09.19
...
(21, 'stevegrock', 'galiterus', 'Steve Grock', 'SteveGrock@recipebook.com', 'Aktif'),
...
--
ALTER TABLE `recipe`
  MODIFY `idrecipe` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
